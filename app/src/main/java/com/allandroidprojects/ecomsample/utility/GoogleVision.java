    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(GoogleVision.this,
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(GoogleVision.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
...
//                    featureList.add(landmarkDetection);
            ...
            protected void onPostExecute(String result) {
                Intent i = new Intent(GoogleVision.this, SearchResultActivity.class);
                i.putExtra("LABELS", result);
                startActivity(i);
                finish();
            }
        }.execute();
...
//        message.append("Texts:\n");
        ...
        if (texts != null) {
            for (int i = 0; i < 1; i++) {
                ...
                message.append(String.format(text.getDescription()));
//                message.append("");
            }
        } else {
//            message.append("nothing\n");
...
//        }
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new GetTokenTask(GoogleVision.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
